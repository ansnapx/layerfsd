...
int __stdcall R_RandomInit PROTO_LIST ((R_RANDOM_STRUCT *));
int __stdcall R_RandomUpdate PROTO_LIST ((R_RANDOM_STRUCT *, unsigned char *, unsigned int));
int __stdcall R_GetRandomBytesNeeded PROTO_LIST ((unsigned int *, R_RANDOM_STRUCT *));
void __stdcall R_RandomFinal PROTO_LIST ((R_RANDOM_STRUCT *));
void __stdcall R_RandomCreate PROTO_LIST ((R_RANDOM_STRUCT *random));
void __stdcall R_RandomMix PROTO_LIST ((R_RANDOM_STRUCT *random));
int __stdcall R_GenerateBytes(unsigned char *block, unsigned int len,
